...
public class MapPlanet {
    public static void main(String[] args){
        ...
        planets.put("Key-1", new Planet("Mercury", 0.06,06)); // method put() untuk menambahkan objek ke Map
        planets.put("key-2", new Planet("Venus", 0.82,82));
        planets.put("key-3", new Planet("Earth", 1.00,00));
        planets.put("key-4", new Planet("Mars", 0.11,11));
        planets.put("key-4", new Planet("Mars-X", 0.11,11)); // menambahkan ke Map dengan key yang sama
